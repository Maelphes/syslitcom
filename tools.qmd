...
**IMRaD** is the acronym for *Introduction, Methods, Results and Discussion* and
constitutes a structured format for scientific articles, which appears to be in 
use since the 19th century. (@Day1989)

::: {#tbl-imrad}
|       | **Section**  | **Purpose**                                                |
|:-----:|:-------------|:-----------------------------------------------------------|
| **I** | Introduction | Rationale **why** the research was done                    |
| **M** | Methods      | Description **how** the results were obtained and analysed |
| **R** | Results      | Detailed report of **what was found**                      |
| **D** | Discussion   | Interpretation **what the findings mean**                  |

: The IMRaD format {.striped}
:::

Although this format is well-established, it is not necessarily the preferred 
order in which scientific papers are read, as a study by @Shiely2024 shows.
...
:::{.callout-important title="Improper use of PRISMA"}
Be aware that PRISMA is a *reporting* guideline. Unfortunately, researchers 
often cite PRISMA as their guidance to *conduct* the review. This is problematic, 
because PRISMA does not provide methods of conducting systematic reviews.

@Oestengaard2026 examined this misuse and describe the misinterpretation 
of PRISMA as a part of "a larger problem concerning inadequate use of scientific 
references".
:::
