...
possess identical spelling, but bear different meanings.
...
which seem relevant to them or are commonly used in their field, whereas authors 
might use different (and sometimes unspecific) expressions to describe the same
subject.
...
instead of explicitly using the word *hypertension* in title or abstract of the 
publications.
