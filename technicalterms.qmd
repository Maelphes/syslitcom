...
subsections, similar to the IMRaD format (Introduction, Methods, Results and 
Discussion) used for structuring scientific articles. A main purpose of such a 
structure is to make the abstract more informative to the reader.
