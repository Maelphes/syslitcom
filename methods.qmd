...
One of the main steps in evidence-based medicine is the critical appraisal of 
evidence. Critical appraisal checklists help to assess the methodological 
...
Filters (also search filters, filter strategies or hedges) are [search strategies](#sec-searchstrategy)
...
The [data fields](#sec-datafield) of databases possess short designations called **field codes**, 
field tags or field labels, which allow to search the fields separately as part 
of a search query or [search strategy](#sec-searchstrategy). Depending on the
[syntax](#sec-syntax) of the database or search interface different field codes
are available for searching. If no field code is used in a search query, the 
search term is usually searched in all fields or a preset variety of fields. 
...
[syntax](#sec-syntax) and index terms of the searched database. As a 
consequence, the search strategy needs to be translated for the use in other 
databases.
...
*JBI Manual* (@JBIManual2020). Depending on the desired type of review 
(e.g. systematic, scoping, narrative, ..., see @sec-review and 
