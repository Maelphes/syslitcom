...
## citation searching {#sec-citationanalysis}

Relevant references can be retrieved by analyzing citation relationships between
known relevant articles, called *seed papers* (also known as *core papers*) and 
cited or citing references. This technique is called **citation searching**, 
**citation analysis** or **citation tracking** (@Hirt2021, @Belter2016, 
@Hinde2015).

::: {.callout-tip title="The TARCiS Statement"}
...
[systematic searching](#sec-syslitsearching).
:::
...
index terms. In cases where the index term does not sufficiently describe the 
